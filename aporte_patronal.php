...
if (bd_verificar_privilegios('aporte_patronal.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
{
...
$f1->addHTML(" <br />"."<div id='titulo'>GENERAR ARCHIVO FIGS PATRONO</div>"."<td colspan='3'><hr size='1' /></td>\n"." </tr>\n");
...
function procesar($d)
{
	...
	else
	{
		...
		$tipo = $d['tipo_id'];
		ir("aporte_patronal2.php?fecha_ini=$fecha_ini&fecha_fin=$fecha_fin&tipo=$tipo");
	}
}
