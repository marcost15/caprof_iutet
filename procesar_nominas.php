...
if (bd_verificar_privilegios('procesar_nominas.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
{
...
$f1->addHTML(" <br />"."<div id='titulo'>PROCESAR NÓMINAS</div>"."<td colspan='3'><hr size='1' /></td>\n"." </tr>\n");
...
function procesar($d)
{
	...
	else
	{
		...
		$tipo = $d['tipo_id'];
		ir("procesar_nominas2.php?fecha_ini=$fecha_ini&fecha_fin=$fecha_fin&tipo=$tipo");
	}
}
