...
if (bd_verificar_privilegios('rp_frm_archivos_fecha.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
{
...
$f1->setLanguage('es');
$f1->addHTML(" <br />"."<div id='titulo'>ARCHIVOS POR FECHA</div>"."<td colspan='3'><hr size='1' /></td>\n"." </tr>\n");
